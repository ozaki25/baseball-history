  ...
  return (
    <section className={`grid grid-cols-1 md:grid-cols-4 gap-6 ${className}`} aria-label="観戦統計">
      <div className="bg-white border border-gray-200 rounded-lg p-6 text-center shadow-sm">
        <h4 className="text-lg font-semibold text-fs-header mb-2">総観戦数</h4>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-6 text-center shadow-sm">
        <h4 className="text-lg font-semibold text-fs-header mb-2">勝率</h4>
        <p
          className="text-3xl font-bold text-fs-header"
