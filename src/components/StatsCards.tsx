  ...
  return (
    <section className={`grid grid-cols-1 md:grid-cols-4 gap-6 ${className}`} aria-label="観戦統計">
      <div className="bg-fs-white border border-fs-gray-200 rounded-lg p-6 text-center shadow-sm">
        ...
        <p className="text-3xl font-bold text-fs-black" aria-label={`総観戦数 ${stats.total} 試合`}>
          {stats.total}
        </p>
        <p className="text-sm text-fs-gray-500 mt-1">試合</p>
      </div>
      ...
      <div className="bg-fs-white border border-fs-gray-200 rounded-lg p-6 text-center shadow-sm">
        ...
        <p className="text-sm text-fs-gray-500 mt-1">勝</p>
      </div>
      
      <div className="bg-fs-white border border-fs-gray-200 rounded-lg p-6 text-center shadow-sm">
        <h4 className="text-lg font-semibold text-result-lose mb-2">
          敗戦数
        </h4>
        <p className="text-3xl font-bold text-result-lose" aria-label={`敗戦数 ${stats.losses} 試合`}>
          {stats.losses}
        </p>
        <p className="text-sm text-fs-gray-500 mt-1">敗</p>
      </div>
      ...
      <div className="bg-fs-white border border-fs-gray-200 rounded-lg p-6 text-center shadow-sm">
        ...
        <p className="text-sm text-fs-gray-500 mt-1">
          {stats.draws > 0 && `引分 ${stats.draws}`}
        </p>
      </div>
    </section>
  );
